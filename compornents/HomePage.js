...
const HomePage = () => {
  return (
    <div>
      ...
      <p>
        food_kamiです。普段は独学でWeb系の学習を行っています。主にHTML/CSS/Javascript/Reactメインに取り扱っています。趣味は、ゲームやご飯巡りです。
        美味しいところがあればSNSを通して発信を行っています。
      </p>
        ...
        <div className="service">
          ...
          <div class="row text-center">
            ...
            <div class="col-md-4">
              <span class="fa-stack fa-4x">
                <i class="fas fa-circle fa-stack-2x text-primary"></i>
                <i class="fas fa-solid fa-calculator fa-stack-1x fa-inverse"></i>
              </span>
